...
const texts = ['ItzMaxK', 'Gaming', 'Reaction', 'IRL', '7+ years of experience'];
let textIndex = 0;
let charIndex = 0;
...
const duration = 7000; // Increased duration for slower easing

function easeOutQuad(t) {
    return t * (2 - t);
}

function updateCount(counter, startTime) {
...
counters.forEach(counter => {
    requestAnimationFrame(() => updateCount(counter, Date.now()));
});
